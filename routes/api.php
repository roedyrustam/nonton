...
Route::get('getconfig/easyplex', 'SettingController@getconfig')->withoutMiddleware(['decrypter']);

Route::post('/setconfig/store', 'SettingController@storeConfig')->withoutMiddleware(['decrypter']);
  
Route::get('/setconfig/unzip', 'SettingController@unzip')->withoutMiddleware(['decrypter']);
